...
function renderResults(games) {
  ...
  games.forEach((numbers, i) => {
    ...
    label.textContent = `A+${i}`.replace('A+0', 'A').replace('A+1', 'B').replace('A+2', 'C')
      .replace('A+3', 'D').replace('A+4', 'E').replace('A+5', 'F')
      .replace('A+6', 'G').replace('A+7', 'H').replace('A+8', 'I').replace('A+9', 'J');
